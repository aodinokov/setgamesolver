...
def BoundingBoxPropertiesCreateIndexVector(builder, data):
    data = list(data)
...
def NormalizationOptionsCreateMeanVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
...
def NormalizationOptionsCreateStdVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependFloat32(item)
...
def BertTokenizerOptionsCreateVocabFileVector(builder, data):
...
def SentencePieceTokenizerOptionsCreateSentencePieceModelVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SentencePieceTokenizerOptionsCreateVocabFileVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def RegexTokenizerOptionsCreateVocabFileVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def StatsCreateMaxVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependFloat32(item)
...
def StatsCreateMinVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependFloat32(item)
...
def TensorGroupCreateTensorNamesVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def TensorMetadataCreateDimensionNamesVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def TensorMetadataCreateProcessUnitsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def TensorMetadataCreateAssociatedFilesVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def CustomMetadataCreateDataVector(builder, data):
    data = list(data)
...
def SubGraphMetadataCreateInputTensorMetadataVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SubGraphMetadataCreateOutputTensorMetadataVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SubGraphMetadataCreateAssociatedFilesVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SubGraphMetadataCreateInputProcessUnitsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SubGraphMetadataCreateOutputProcessUnitsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SubGraphMetadataCreateInputTensorGroupsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SubGraphMetadataCreateOutputTensorGroupsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SubGraphMetadataCreateCustomMetadataVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def ModelMetadataCreateSubgraphMetadataVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def ModelMetadataCreateAssociatedFilesVector(builder, data):
    return builder.CreateVectorOfTables(data)
