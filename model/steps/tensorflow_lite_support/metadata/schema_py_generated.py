...
def CustomQuantizationCreateCustomVector(builder, data):
    data = list(data)
...
def QuantizationParametersCreateMinVector(builder, data):
    data = list(data)
...
def QuantizationParametersCreateMaxVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependFloat32(item)
...
def QuantizationParametersCreateScaleVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependFloat32(item)
...
def QuantizationParametersCreateZeroPointVector(builder, data):
    data = list(data)
...
def Int32VectorCreateValuesVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
...
def Uint16VectorCreateValuesVector(builder, data):
    data = list(data)
...
def Uint8VectorCreateValuesVector(builder, data):
    data = list(data)
    builder.StartVector(1, len(data), 1)
    for item in reversed(data):
        builder.PrependUint8(item)
...
def SparsityParametersCreateTraversalOrderVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def SparsityParametersCreateBlockMapVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def SparsityParametersCreateDimMetadataVector(builder, data):
...
def TensorCreateShapeVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def TensorCreateShapeSignatureVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def ConcatEmbeddingsOptionsCreateNumColumnsPerChannelVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def ConcatEmbeddingsOptionsCreateEmbeddingDimPerChannelVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def ReshapeOptionsCreateNewShapeVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def SqueezeOptionsCreateSqueezeDimsVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def OperatorCreateInputsVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def OperatorCreateOutputsVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def OperatorCreateCustomOptionsVector(builder, data):
    data = list(data)
    builder.StartVector(1, len(data), 1)
    for item in reversed(data):
        builder.PrependUint8(item)
...
def OperatorCreateMutatingVariableInputsVector(builder, data):
    data = list(data)
    builder.StartVector(1, len(data), 1)
    for item in reversed(data):
...
def OperatorCreateIntermediatesVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def SubGraphCreateTensorsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SubGraphCreateInputsVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def SubGraphCreateOutputsVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def SubGraphCreateOperatorsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def BufferCreateDataVector(builder, data):
    data = list(data)
    builder.StartVector(1, len(data), 1)
    for item in reversed(data):
        builder.PrependUint8(item)
...
def SignatureDefCreateInputsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def SignatureDefCreateOutputsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
class SignatureDefT(object):
    ...
    def __init__(
        ...
        self.methodName = methodName  # type: Optional[str]
...
def ModelCreateOperatorCodesVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def ModelCreateSubgraphsVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def ModelCreateBuffersVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def ModelCreateMetadataBufferVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def ModelCreateMetadataVector(builder, data):
    return builder.CreateVectorOfTables(data)
...
def ModelCreateSignatureDefsVector(builder, data):
    return builder.CreateVectorOfTables(data)
